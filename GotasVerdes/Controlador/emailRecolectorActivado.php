...
try {
    ...
    $mail->addAddress($nuevoCorreo); // Agregar un destinatario
    ...
    '<html>
        ...
        <body>
            <div class="container">          
                ...
                <p>Su cuanta fue activada, ahora forma parte de nuestro equipo</p>
                <p><a href="http://localhost/GotasVerdes/Vista/login/login.html">Para iniciar sesión da clic aquí</a></p>
            </div>
        </body>
    </html>';
