...
<head>
    ...
    <title>Mapa</title>
    <link rel="stylesheet" href="../css/estiloMapaUsuario.css">
    <link rel="stylesheet" href="../css/style.css">
    <script src="../js/mapaNegocio.js"></script>
    <script>
var ubicaciones = <?php echo json_encode($ubicaciones); ?>;
</script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBDaeWicvigtP9xPv919E-RNoxfvC-Hqik&callback=loadGoogleMapsScript"></script>
...
<header>
        <nav>
            ...
            <ul class="XD mostrar">
                ...
                <li><a href="mapaInvitado.php">Mapa</a></li>
    ...
    <main>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <div class="negocio-info--container">
                            <h2 class="negocio-title">*House of*</h2>
                            <h3 class="negocio-subtitle">Dirección</h3>
                            <p class="negocio-text">Mariano Matamoros #26</p>
                        </div>
                    </div>
                    <!-- 
        ...
        <section class="map-section--container">
            <img id="customIcon"
                ...
                style="display: none;">
            <div id="map"></div>
            <script src="../js/mapaUsuario.js" action="../../Controlador/ctrlRegistrarNegocioUsuario.php"></script>
            <script
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDBFyGZ3Aihm3uJBsX0cbcihwwCdYUkCQk&callback=iniciarMap"></script>
        </section>
        <section class="team-section--container">
            <div class="team-info">
                <h1>Registrate como usuario e inicia sesión!</h1>
                <p>Da clic en el botón y empieza a cambiar al mundo.</p>
                    <a href="../usuario/registroUsuario.php" class="btn btn-success">Regístrate ahora</a>
            </div>
        </section>
    </main>
