...
<head>
    ...
    <link rel="stylesheet" href="../css/estiloRegistrarNegocioUsuario.css">
    <link rel="stylesheet" href="../css/style.css">
    <script src="../js/mapaNegocio.js"></script>
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBDaeWicvigtP9xPv919E-RNoxfvC-Hqik&callback=loadGoogleMapsScript"></script>
...
<body>
    ...
    <main>
    <div class="form-regis-neg">
        <h2>Registra tu negocio</h2>
        <form id="negocio-form" action="../../Controlador/ctrlRegistrarNegocioUsuario.php" method="post">
            <input type="hidden" name="id_usuario" value="<?php echo $id_usuario; ?>">
            <div class="form-group">
                <p>Ingresa el nombre de tu negocio</p>
                <input type="text" class="form-control" id="nombre-negocio" placeholder="Ingresa el nombre de tu negocio" name="nombre_negocio" required>
            </div>
            <div class="form-group">
                <p hidden>Ingresa la latitud</p>
                <input type="text" class="form-control" id="latitud" placeholder="Latitud" name="latitud" required hidden>
            </div>
            <div class="form-group">
                <p hidden>Ingresa la longitud</p>
                <input type="text" class="form-control" id="longitud" placeholder="Longitud" name="longitud" required hidden>
            </div>
