    ...
    <main>
        ...
        <div class="all-container">
            ...
            <section class="shop-points--container">
                <div class="div-points--container">
                    <span class="dropCoin-icon"></span>
                    <p id="points-user">0</p>
                </div>
                    <button  type="button" class="boton-historial btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Historial
                    </button>
                ...
                <section class="shop-items--container">
                            ...
                            <div class="price--container">
                                ...
                                <div class="left-price--container">
                                    ...
                                    <div class="minus-plus--container">
                                        ...
                                        <input id="input-minus-plus-1" class="input-minus-plus" type="number"
                                            placeholder="0" min="0" value="0">
                                        <span id="plus-1" class="plus">+</span>
                                    </div>
                                    <p id="not-enought-coins" class="not-enought-coins" style="display: none;">No tienes
                                        monedas suficientes</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="price--container">
                                ...
                                <div class="left-price--container">
                                    ...
                                    <div class="minus-plus--container">
                                        ...
                                        <input id="input-minus-plus-2" class="input-minus-plus" type="number"
                                            placeholder="0" min="0" value="0">
                                        <span id="plus-2" class="plus">+</span>
                                    </div>
                                    <p id="not-enought-coins2" class="not-enought-coins" style="display: none;">No
                                        tienes monedas suficientes</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="price--container">
                                ...
                                <div class="left-price--container">
                                    ...
                                    <div class="minus-plus--container">
                                        ...
                                        <input id="input-minus-plus-3" class="input-minus-plus" type="number"
                                            placeholder="0" min="0" value="0">
                                        <span id="plus-3" class="plus">+</span>
                                    </div>
                                    <p id="not-enought-coins3" class="not-enought-coins" style="display: none;">No
                                        tienes monedas suficientes</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="price--container">
                                ...
                                <div class="left-price--container">
                                    ...
                                    <div class="minus-plus--container">
                                        ...
                                        <input id="input-minus-plus-4" class="input-minus-plus" type="number"
                                            placeholder="0" min="0" value="0">
                                        <span id="plus-4" class="plus">+</span>
                                    </div>
                                    <p id="not-enought-coins4" class="not-enought-coins" style="display: none;">No
                                        tienes monedas suficientes</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="foot-sumbit-andcar">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                            class="bi bi-cart4" viewBox="0 0 16 16" hidden>
                            <path
