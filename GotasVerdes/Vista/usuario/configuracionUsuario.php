<?php
  ...
  $id_usuario;
  include '../../Controlador/ctrolDatosUsuario.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <main>
    <div class="wrapper">
      <div class="left">
        <img src="../img/indexImg/MascotaGotasVerdesjpg-removebg-preview.png" alt="user" width="200">
        <h3><?php echo $nombreUsu; ?></h3>
      </div>
      <div class="right">
        <h2>Editar perfil</h2>
        <form class="formm" action="../../Controlador/ctrlModificarDatosUsuario.php" method="post">
          <div class="input-box">
            <svg id="logo" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
              class="bi bi-person-fill" viewBox="0 0 16 16">
              <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
            </svg>
            <label>Nombre del usuario</label>
            <input type="text"  name="nom_usu" value="<?php echo $nombreUsu;?>" required>
          ...
          <div class="input-box">
            ...
            <input type="email" name="cor_usu" value="<?php echo $correoUsu;?>" required>
          ...
          <div class="input-box">
            ...
            <input type="text" name="tel_usu" value="<?php echo $telefonoUsu;?>" maxlength="10" required>
          ...
          <div class="input-box">
            ...
            <input type="password" id="password" name="pas_usuario" value="<?php echo $cont;?>" required>
  ...
  <footer>
    <div class="footer-section">
      <div class="up-footer--container">
        <ul>
          <li class="footer-sidebar--socialmedia"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
