...
<header>
    ...
    <main>
        <section>
            <p id="texto-primero">¿Qué tan contaminante es el aceite?</p>
            <!-- Contenedor de la imagen y texto superpuesto -->
            <div class="image-container">
                <img src="../../Vista/imgSaberMas/sm2--1.png" alt="Descripción de la imagen">
                <!--       <div class="overlay-text"><br> Una sola gota de aceite  <br>puede contaminar hasta 25  <br> litros de agua potable.</div> -->
            </div>
            <!-- Contenedor de la segunda imagen -->
            <div class="image-container-2">
                <img src="../../Vista/imgSaberMas/sm3.png" alt="Descripción de la imagen 2">
            </div>
            <p id="texto-segundo">¿Qué se puede hacer?</p>

            <div class="image-text-container">
                <!-- Primer conjunto de imagen y texto -->
                <div class="image-text">
                    <img src="../../Vista/imgSaberMas/sm4.png" alt="Descripción de la imagen 3">
                    <p>¡NO TIRES EL ACEITE AL AGUA!</p>
                </div>

                <!-- Segundo conjunto de imagen y texto -->
                <div class="image-text">
                    <img src="../../Vista/imgSaberMas/sm5.png" alt="Descripción de la imagen 4">
                    <p>¡NO LO TIRES SOBRE LAS PLANTAS!</p>
                </div>
            </div>

            <div class="list">
                <!-- Título del listado -->
                <h3>Maneras de reutilizar el aceite usado:</h3>
                <!-- Lista de elementos -->
                <ul>
                    <li>➣ Filtración y almacenamiento</li>
                    <li>➣ Freír alimentos similares</li>
                    <li>➣ Hacer adobos y salsas</li>
                    <li>➣ Hacer productos caseros</li>
                    <li>➣ Usar como lubricante</li>
                    <li class="image6-1">
                        <img src="../../Vista/imgSaberMas/sm6-1.png" alt="Imagen superpuesta" class="zz">
                    </li>
                    <li class="image6-2">
                        <img src="../../Vista/imgSaberMas/sm6-2.png" alt="Imagen superpuesta" class="zzz">
                    </li>
                </ul>
            </div>

            <p id="texto-tercero">Luchemos por un planeta verde 🌱</p>

            <p id="texto-carusel">Empresas que recilan y fomentan el reciclaje</p>

            <!-- Inicia Carousel -->
            <div id="multi-item-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-wrap="true">
                <!-- Indicators/dots -->
                <ol class="carousel-indicators">
                    <li data-bs-target="#multi-item-carousel" data-bs-slide-to="0" class="active"></li>
                    <li data-bs-target="#multi-item-carousel" data-bs-slide-to="1"></li>
                    <li data-bs-target="#multi-item-carousel" data-bs-slide-to="2"></li>
                    ...
                    <div class="carousel-item active">
                        <div class="carousel-grid">
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl1.png" alt="NESCAFÉ" class="d-block">
                            </div>
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl2.png" alt="Nutrioli" class="d-block">
                            </div>
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl3.png" alt="Aires de Campo" class="d-block">
                            </div>
                            <!-- Agrega más imágenes según sea necesario -->
                        </div>
                    </div>
                    <div class="carousel-item">
                        <!-- Agrega más slides con imágenes en grupos -->
                        <div class="carousel-grid">
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl4.png" alt="Purina®" class="d-block">
                            </div>
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl5.png" alt="Tetra Pak®" class="d-block">
                            </div>
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl6.png" alt="Grupo Modelo" class="d-block">
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-grid">
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl7.png" alt="Barcel y Bimbo" class="d-block">
                            </div>
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl8.png" alt="Amazon" class="d-block">
                            </div>
                            <div class="carousel-item-container">
                                <img src="../../Vista/imgCarrusel/cl9.png" alt="Latitud" class="d-block">
                            </div>
                        </div>
                    </div>
