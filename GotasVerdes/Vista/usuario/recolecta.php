...
<head>
    ...
    <link rel="stylesheet" href="../css/recolecta.css">
...
<body>
    ...
    <main>
        <!--AQUÍ VA SU CÓDIGO-->
        <p class="texto" style=font-size:1.5em;>Recuerda que la recolecta del residuo de aceite es en recipientes limpios y adecuados a la
            cantidad recolectada</p>

        <div class="container">
            <form action="../../Controlador/ctrlRecolecta.php" method="post" id="recolecta-form">
                <div class="fondo-verde">
                    ...
                    <input type="text" name="nom_rec" id="input-nom_rec" class="input-linea" placeholder="Escribe aquí">
                    <input type="hidden" name="id_usuario" value="<?php echo $id_usuario;?>">
                </div>

                <div class="fondo-verde">
                    <!-- Contenido del segundo contenedor -->
                    <p>Cantidad recolectada</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor"
                        class="bi bi-droplet-fill" viewBox="0 0 16 16">
                        <path
                            d="M8 16a6 6 0 0 0 6-6c0-1.655-1.122-2.904-2.432-4.362C10.254 4.176 8.75 2.503 8 0c0 0-6 5.686-6 10a6 6 0 0 0 6 6ZM6.646 4.646l.708.708c-.29.29-1.128 1.311-1.907 2.87l-.894-.448c.820-1.641 1.717-2.753 2.093-3.13Z" />
                    </svg><br>
                    <input type="text" name="can_rec" id="input-can_rec" class="input-linea" placeholder="Escribe aquí"
                        maxlength="2">
                </div>
                ...
                <div class="fondo-verde">
                    ...
                    <input type="text" name="dir_rec" id="input-dir_rec" class="input-linea" placeholder="Escribe aquí">
                </div>
        </div>
        <button type="submit" class="boton-personalizado" id="submitBtn" disabled>Enviar</button>
        </form>
    </main>
    ...
    <script src="../js/restricciones_recolecta.js"></script>
</body>
