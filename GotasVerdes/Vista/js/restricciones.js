document.addEventListener('DOMContentLoaded', function () {
    const inputUsuario = document.querySelector('.form-box.usu .inp');
    const continuarButton = document.querySelector('.form-box.usu .btn');
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (response === 'existe') {
                    ...
                    continuarButton.disabled = true; // Desactiva el botón si el nombre de usuario ya existe
                } else {
                    errorMsg.style.display = 'none';
                    continuarButton.disabled = false; // Activa el botón si el nombre de usuario no existe
                }
            }
        };
...
document.addEventListener('DOMContentLoaded', function () {
    const inputTelefono = document.querySelector('.form-box.telef .inp');
    const continuarButton = document.querySelector('#btn3');
