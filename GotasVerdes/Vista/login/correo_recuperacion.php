...
<head>
    ...
    <title>Ingresa tu correo eléctronico</title>
    ...
    <link rel="stylesheet" href="../css/correo_rec.css">
</head>
<body>
    <header>
        <nav>
            ...
            <ul class="XD mostrar">
                ...
                <li><a href="../invitado/mapaInvitado.html">Mapa</a></li>
                <li><a href="../invitado/tiendaInvitado.html">Tienda</a></li>
    ...
    <div class="wrapper">
        <div class="input-box correo">
            ...
            <form action="../../Controlador/ctrlRecuperarContraseña.php" method="post">
            <div class="input-box">
                <span></span>
                <label>Correo eléctronico</label>
                <p>Ingresa tu correo para el envío del código de recuperación de contraseña</p>
                <input type="email" name="cor_recuperacion" required placeholder=" Ingrese su correo electronico">
            </div>
