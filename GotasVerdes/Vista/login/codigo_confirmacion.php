...
if(isset($_GET['gmail']) && isset($_GET['token'])){
    $cor_recuperarUsuario = $_GET['gmail'];
    $token_recuperar = $_GET['token'];
}else{
...
<head>
    ...
    <title>Ingresa tu código de verificación</title>
    ...
    <link rel="stylesheet" href="../css/codigo_conf.css">
</head>
...
<header>
    ...
    <div class="wrapper">
        <div class="input-box correo">
            ...
            <form action="contraseña_recuperacion.php" method="POST">
                <div class="input-box">
                    <span></span>
                    <label class="fa-code-simple">Código</label>
                    <p>Ingresa el código que se le mandó al correo</p>
                    <input type="number" name="codigo" required placeholder=" Ingrese el código de verificación" >
                    <input type="hidden" name="gmail" value="<?php echo $cor_recuperarUsuario;?>">
                    <input type="hidden" name="token" value="<?php echo $token_recuperar;?>">
                </div>
